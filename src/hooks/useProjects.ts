...
export const useProjects = (userId?: string) => {
  ...
  //
  // Fix: tidligere `map → filter(!e.end_time) → map` på samme array
  // resulterte i en array av `undefined` fordi andre `.map` kalte `.id`
  // på strings, så pause-query returnerte alltid tomt.
